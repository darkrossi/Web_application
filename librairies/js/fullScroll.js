    ...
    b.fn.fullpage = function (c) {
        ...
        function y(a, d) {
            if (h[a]) {
                ...
                if (0 < d.length)
                    if (c = "top" === c ? !d.scrollTop() : "bottom" === c ? d.scrollTop() + 1 + d.innerHeight() >= d[0].scrollHeight : void 0, c)
                        f();
                    else
                        return!0;
                else
        ...
        function l(a, d, e) {
            ...
            if ("undefined" !== typeof f && (d = {element: a, callback: d, isMovementUp: e, dest: f, dtop: f.top, yMovement: E(a), anchorLink: a.data("anchor"), sectionIndex: a.index(".fp-section"), activeSlide: a.find(".fp-slide.active"), activeSection: b(".fp-section.active"), leavingSection: b(".fp-section.active").index(".fp-section") + 1, localIsResizing: w}, !(d.activeSection.is(a) && !w || c.scrollBar && b(window).scrollTop() === d.dtop))) {
                if (d.activeSlide.length)
                    var g = d.activeSlide.data("anchor"), h = d.activeSlide.index();
        ...
        function pa(a) {
            if (c.css3 && c.autoScrolling && !c.scrollBar)
                W("translate3d(0px, -" + a.dtop + "px, 0px)", !0), setTimeout(function () {
                    X(a)
                }, c.scrollingSpeed);
            else {
                var d = qa(a);
        ...
        function qa(a) {
            var b = {};
            c.autoScrolling &&
                    !c.scrollBar ? (b.options = {top: -a.dtop}, b.element = "." + Y) : (b.options = {scrollTop: a.dtop}, b.element = "html, body");
            return b
        }
        function ra(a) {
        ...
        function ba() {
            ...
            if (J) {
                ...
                clearTimeout(da), da = setTimeout(function () {
        ...
        function x(a) {
            ...
            if (e.length)
                ...
                f = a.get(0).scrollHeight, c.verticalCentered && (f = a.find(".fp-tableCell").get(0).scrollHeight);
            ...
            f > b ? e.length ? e.css("height", b + "px").parent().css("height", b + "px") : (c.verticalCentered ? a.find(".fp-tableCell").wrapInner('<div class="fp-scrollable" />') :
                    a.wrapInner('<div class="fp-scrollable" />'), a.find(".fp-scrollable").slimScroll({allowPageScroll: !0, height: b + "px", size: "10px", alwaysVisible: !0})) : ea(a);
            a.css("overflow", "")
        }
        function ea(a) {
        ...
        function V(a, b, e, f) {
            var g = "";
            c.anchors.length ? (a ? ("undefined" !== typeof e && (g = e), "undefined" === typeof b && (b = a), H = b, location.hash = g + "/" + b) : ("undefined" !==
                    typeof a && (H = b), location.hash = e), B(location.hash)) : "undefined" !== typeof a ? B(f + "-" + a) : B(String(f))
        }
        function B(a) {
            a = a.replace("/", "-").replace("#", "");
        ...
        c = b.extend({menu: !1, anchors: [], navigation: !1, navigationPosition: "right", navigationColor: "#000", navigationTooltips: [],
            ...
            slideSelector: ".slide", afterLoad: null, onLeave: null, afterRender: null, afterResize: null, afterReBuild: null, afterSlideLoad: null, onSlideLeave: null}, c);
        (function () {
        ...
        b.fn.fullpage.setAutoScrolling = function (a) {
            c.autoScrolling = a;
            a = b(".fp-section.active");
            c.autoScrolling && !c.scrollBar ? (b("html, body").css({overflow: "hidden", height: "100%"}), g.css({"-ms-touch-action": "none", "touch-action": "none"}),
                    a.length && r(a.position().top)) : (b("html, body").css({overflow: "visible", height: "initial"}), g.css({"-ms-touch-action": "", "touch-action": ""}), r(0), b("html, body").scrollTop(a.position().top))
        };
        ...
        b.fn.fullpage.setAllowScrolling = function (a, c) {
            if ("undefined" != typeof c)
                c = c.replace(" ", "").split(","), b.each(c, function (c, d) {
                    switch (d) {
                        case "up":
                            h.up = a;
                            break;
                ...
                if (b.fn.fullpage.setMouseWheelScrolling(!0), J || ja)
                    MSPointer = ia(), b(document).off("touchstart " + MSPointer.down).on("touchstart " +
                            MSPointer.down, oa), b(document).off("touchmove " + MSPointer.move).on("touchmove " + MSPointer.move, na)
            } else if (b.fn.fullpage.setMouseWheelScrolling(!1), J || ja)
                MSPointer = ia(), b(document).off("touchstart " + MSPointer.down), b(document).off("touchmove " + MSPointer.move)
        };
        ...
        var t = !1, J = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|Windows Phone|Tizen|Bada)/), ja = "ontouchstart"in window || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints, g = b(this), m = b(window).height(), k = !1, w = !1, p, H, n, Y = "fullpage-wrapper", h = {up: !0, down: !0, left: !0, right: !0};
        b.fn.fullpage.setAllowScrolling(!0);
        c.css3 && (c.css3 = ua());
        b(this).length ? (g.css({height: "100%", position: "relative"}), g.addClass(Y)) : C("error", "Error! Fullpage.js needs to be initialized with a selector. For example: $('#myContainer').fullpage();");
        ...
        b(document).keydown(function (a) {
            if (c.keyboardScrolling && c.autoScrolling &&
                    (40 != a.which && 38 != a.which || a.preventDefault(), !k))
                switch (a.which) {
                    case 38:
                    case 33:
